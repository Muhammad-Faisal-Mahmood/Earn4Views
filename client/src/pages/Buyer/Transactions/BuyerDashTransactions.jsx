...
const BuyerDashTransactions = () => {
  ...
  return (
    <>
      ...
      <div className="mx-4 md:mx-[7vw] flex flex-col gap-12 py-10">
        ...
        <div className="shadow-basic rounded-xl py-8 px-4 md:p-8 grid gap-10  bg-white items-center">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-20">
            <div>
              ...
              <input
                type="text"
                className="p-1 px-2 rounded-md md:p-2 shadow-basic bg-white"
          ...
          <div className="w-full">
            <button
              ...
              className="text-white p-2 md:p-4 font-bold rounded-lg w-full two-color-gradient-background"
            >
              Pay Now
            </button>
          </div>
