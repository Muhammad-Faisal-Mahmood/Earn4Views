...
const EditShippingPrice = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`https://stealth-ecommerce-12f9ab59b8a8.herokuapp.com/users/shipping_price/${ID}/update`, {
                method: 'PUT',
                headers: {
            ...
            if (response.ok) {
                ...
                showAlert('Shipping Price Updated','success');
                    ...
                    <CForm className="bgForm" onSubmit={handleFormSubmit}>
                        ...
                        <div className="mb-3">
                            <CButton type="submit" className="mb-3" disabled={isSubmitting}>
                                {isSubmitting ? 'Updating...' : 'Update Shipping Price'}
                            </CButton>
                        </div>
                    </CForm>
                </CCardBody>
