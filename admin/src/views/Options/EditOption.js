...
const EditOption = () => {
    ...
    const [formData, setFormData] = useState({
        name: item.name,
        option_group: item.option_group.uuid,
    });
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`https://stealth-ecommerce-12f9ab59b8a8.herokuapp.com/products/option/${ID}/update`, {
                method: 'PUT',
                headers: {
            ...
            if (response.ok) {
                ...
                showAlert('Option Updated successfully','success');
                ...
                showAlert('Failed to Update Option','danger');
            }
        } catch (error) {
                    ...
                    <CForm className="bgForm" onSubmit={handleFormSubmit}>
                        ...
                        <div className="mb-3">
                            <CButton type="submit" className="mb-3" disabled={isSubmitting}>
                                {isSubmitting ? 'Updating Option...' : 'Update'}
                            </CButton>
                        </div>
                    </CForm>
                </CCardBody>
